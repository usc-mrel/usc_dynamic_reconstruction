function [csm] = ismrm_estimate_csm_walsh_optimized_yt(img, smoothing, N_iter)
%
...
[csm,~] = ismrm_eig_power(Rs, N_iter); % using power method
...
function [v,d] = ismrm_eig_power(R, N_iterations)
