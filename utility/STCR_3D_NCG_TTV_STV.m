function [x_out, cost] = STCR_3D_NCG_TTV_STV(E, x0_, y, weight_tTV, weight_sTV, opt)
    ...
    l1_func = potential_fun('fair-l1', delta);    % with default delta  = 0.01
